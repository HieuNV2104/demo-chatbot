    ...
    return (
        <div>
            ...
            >
                ...
                >
                    {!isFinished && <Loading02 className="w-3 h-3 text-gray-500 animate-spin shrink-0" />}
                    {isFinished && !isShowDetail && <CheckCircle className="w-3 h-3 text-[#12B76A] shrink-0" />}
                    ...
                    <span className="text-xs font-medium text-gray-700 truncate" title={toolName}>
                        {toolName}
                    </span>
                    <ChevronDown
                        className={cn(
