            ...
            >
                ...
                >
                    ...
                    {nodeInfo.status !== 'running' && !hideInfo && (
                        <div className="shrink-0 text-gray-500 text-xs leading-[18px]">{`${getTime(
                            nodeInfo.elapsed_time || 0
                        )} · ${getTokenCount(nodeInfo.execution_metadata?.total_tokens || 0)} tokens`}</div>
                    )}
