const translation = {
    ...
    chat: {
        ...
        configDisabled: 'La configuración de la sesión anterior se ha utilizado para esta sesión.',
    ...
    errorMessage: {
        ...
        waitForResponse: 'Por favor espere a que la respuesta al mensaje anterior se complete.'
    }
};
